...
/**
 * Unit tests for the index-only ES connector implementation.
 *
 * @author Matt Pearce (mpearce@opensourceconnections.com)
 */
public class IndexOnlyElasticsearchConnectorTest {
    ...
    public void isAvailableReturnsFalse_whenStatusRed() {
        mockServerClient.when(request().withPath(ElasticsearchConnector.CLUSTER_HEALTH_ENDPOINT))
                .respond(response().withStatusCode(200).withBody("{\"cluster_name\":\"elasticsearch\",\"status\":\"red\",\"timed_out\":false,\"number_of_nodes\":1,\"number_of_data_nodes\":1,\"active_primary_shards\":0,\"active_shards\":0,\"relocating_shards\":0,\"initializing_shards\":0,\"unassigned_shards\":0,\"delayed_unassigned_shards\":0,\"number_of_pending_tasks\":0,\"number_of_in_flight_fetch\":0,\"task_max_waiting_in_queue_millis\":0,\"active_shards_percent_as_number\":100.0}", MediaType.JSON_UTF_8));
        assertThat(connector.isAvailable()).isFalse();
    }
    ...
    public void isAvailableReturnsTrue_whenStatusYellow() {
        mockServerClient.when(request().withPath(ElasticsearchConnector.CLUSTER_HEALTH_ENDPOINT))
                .respond(response().withStatusCode(200).withBody("{\"cluster_name\":\"elasticsearch\",\"status\":\"yellow\",\"timed_out\":false,\"number_of_nodes\":1,\"number_of_data_nodes\":1,\"active_primary_shards\":0,\"active_shards\":0,\"relocating_shards\":0,\"initializing_shards\":0,\"unassigned_shards\":0,\"delayed_unassigned_shards\":0,\"number_of_pending_tasks\":0,\"number_of_in_flight_fetch\":0,\"task_max_waiting_in_queue_millis\":0,\"active_shards_percent_as_number\":100.0}", MediaType.JSON_UTF_8));
    ...
    public void isAvailableReturnsTrue_whenStatusGreen() {
        mockServerClient.when(request().withPath(ElasticsearchConnector.CLUSTER_HEALTH_ENDPOINT))
                .respond(response().withStatusCode(200).withBody("{\"cluster_name\":\"elasticsearch\",\"status\":\"green\",\"timed_out\":false,\"number_of_nodes\":1,\"number_of_data_nodes\":1,\"active_primary_shards\":0,\"active_shards\":0,\"relocating_shards\":0,\"initializing_shards\":0,\"unassigned_shards\":0,\"delayed_unassigned_shards\":0,\"number_of_pending_tasks\":0,\"number_of_in_flight_fetch\":0,\"task_max_waiting_in_queue_millis\":0,\"active_shards_percent_as_number\":100.0}", MediaType.JSON_UTF_8));
        assertThat(connector.isAvailable()).isTrue();
    }
    ...
    @Test(expected = IOException.class)
    public void createIndexThrowsException_whenCreationReturnsError() throws Exception {
        final String requestBody = ConnectorUtils.readConfig(ConnectorUtils.getStreamForMappingsFile(IndexOnlyElasticsearchConnector.MAPPINGS_FILE).get());
        ...
        mockServerClient.when(request().withPath("/" + INDEX_NAME).withMethod(HttpPut.METHOD_NAME))
                .respond(response().withBody("{\"error\":" +
                        ...
                        "\"index_uuid\":\"gLXTrMZMQ5S4mav9gdTXtA\"," +
                        "\"index\":\"rre\"}," +
                        "\"status\":400}", MediaType.JSON_UTF_8));
    ...
    public void createIndexReturnsFalse_whenCreationFails() throws Exception {
        mockServerClient.when(request().withPath("/" + INDEX_NAME).withMethod(HttpPut.METHOD_NAME))
                .respond(response().withBody("{\"acknowledged\":false,\"shards_acknowledged\":false,\"index\":\"rre\"}", MediaType.JSON_UTF_8));
        assertThat(connector.createIndex(INDEX_NAME)).isFalse();
    ...
    public void createIndexReturnsTrue_whenCreationSucceeds() throws Exception {
        mockServerClient.when(request().withPath("/" + INDEX_NAME).withMethod(HttpPut.METHOD_NAME))
                .respond(response().withBody("{\"acknowledged\":true,\"shards_acknowledged\":true,\"index\":\"rre\"}", MediaType.JSON_UTF_8));
    ...
    public void storeItems() {
        ...
        mockServerClient.verify(
                request()
                        .withMethod(HttpPost.METHOD_NAME)
                        .withPath("/_bulk")
                        .withBody("{\"index\":{\"_index\":\"rre\",\"_id\":\"1\"}}\n" +
                                "{\"id\":\"1\",\"version\":\"1.0\",\"totalHits\":0}\n" +
                                "{\"index\":{\"_index\":\"rre\",\"_id\":\"2\"}}\n" +
