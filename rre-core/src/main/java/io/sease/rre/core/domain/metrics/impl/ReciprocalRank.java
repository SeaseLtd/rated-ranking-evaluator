...
public class ReciprocalRank extends Metric {
    ...
    public ReciprocalRank(@JsonProperty("k") final int k,
        ...
        if (maximumGrade == null) {
            ...
            this.fairgrade = Optional.ofNullable(missingGrade).map(BigDecimal::valueOf).orElseGet(() -> this.maxgrade.divide(BigDecimal.valueOf(2), 8, RoundingMode.HALF_UP));
        }
    }
