...
def retrieve_and_add_documents(config: Config, data_store: DataStore) -> None:
    for query in data_store.get_queries():
        docs_eval: List[Document] = search_engine.fetch_for_evaluation(keyword=query.text,
...
if __name__ == "__main__":
    ...
    writer.write(config.output_destination, data_store)
