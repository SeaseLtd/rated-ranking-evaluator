...
def generate_and_add_queries(llm_service: LLMService, config: Config, data_store: DataStore, docs_to_generate_queries: List[Document]) -> None:
    ...
    for doc in docs_to_generate_queries:
        ...
        for query_text in query_response.get_queries():
            ...
            data_store.create_rating_score(query_id, doc.id, max(config.relevance_label_set), "Default max rating is assigned because the query is generated by the document")
