...
Create a [config.yaml](../../configs/dataset_generator/default.yaml) file in the dataset-generator directory. This file 
...
Fill [LLM configuration file](../../configs/dataset_generator/llm.yaml) with your information and create the `.env` file in dataset-generator 
